...
module.exports = function (ctx) {
    ...
    // 替换java
    fs.readFile("plugins/cordova-plugin-launchscreen/src/android/MainActivity_new.java", "utf8", function (err, data) {
      if (err) {
        console.log("android copy file failed");
        return;
      }
      ...
      fs.writeFile(
        ...
        function (err) {
          if (err) {
            console.log("android copy MainActivity failed");
          } else {
            console.log("android copy MainActivity success");
          }
        }
      );
    });
